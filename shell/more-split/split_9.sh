...
# NCaltech
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 0 1 
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 2 
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 3 
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 4
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 5
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 6
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 7
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 8
python ecsnn.py -arch=vgg5 -act=snn -data_dir=./NCaltech/ -dataset=ncaltech -prune -b=16 -split_dir=./splitted_9/ -device=cuda:4 -apoz=95 -c 9 
